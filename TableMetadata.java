...
import yohx.utilities.MyParser;
...
public class TableMetadata {
    ...
    public <T> T fillObject(ResultSet res) throws Exception{
        Constructor<?> construct=this.getSubject().getClass().getConstructor();
        Object newObj=construct.newInstance();
        Field[] fields=this.getSubject().getClass().getDeclaredFields();
        for (int i = 0; i < fields.length; i++) {
    ...
    public String getFieldPredicates(String select_query) throws Exception{
        String predicate="";
